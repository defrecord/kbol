...
poetry run kbol query "What does the book 'Machine Learning Engineering with Python' cover about MLOps and production deployment?"

# Verify feature engineering coverage
poetry run kbol query "What practical examples are shown in 'Python Feature Engineering Cookbook'?"
#+end_src
